...
export const FUNCTION_CATALOG: FunctionCategory[] = [
    {
        ...
        entries: [
            ...
            },
            {
                ...
                description: 'Converts a Roman numeral string into an Arabic number.',
            },
            {
                name: 'ASIN',
                syntax: 'ASIN(Number)',
            ...
            },
            {
                ...
                description:
                    'Returns the inverse trigonometric tangent of specified x and y coordinates.',
            },
            {
                name: 'ATANH',
                syntax: 'ATANH(Number)',
            ...
            },
            {
                ...
                description: 'Converts a positive integer to text in a specified base.',
            },
            {
                name: 'CEILING',
            ...
            },
            {
                ...
                description: 'Returns the number of combinations (without repetitions).',
            },
            {
                name: 'COMBINA',
            ...
            },
            {
                name: 'CSC',
                syntax: 'CSC(Number)',
                description: 'Returns the cosecant of the given angle (in radians).',
            },
            {
                name: 'CSCH',
                syntax: 'CSCH(Number)',
            ...
            },
            {
                ...
                description: 'Converts text in a given numeral system to a positive integer.',
            },
            {
                name: 'DEGREES',
            ...
            },
            {
                ...
                syntax: 'EVEN(Number)',
                description:
                    'Rounds positive numbers up to the next even integer, negative numbers down.',
            },
            {
                name: 'EXP',
                syntax: 'EXP(Number)',
            ...
            },
            {
                ...
                description: 'Returns the number of multiset combinations.',
            },
            {
                name: 'ODD',
                syntax: 'ODD(Number)',
                description:
                    'Rounds positive numbers up to the next odd integer, negative numbers down.',
            },
            {
                name: 'PI',
                syntax: 'PI()',
                description: 'Returns 3.14159265358979, the value of the mathematical constant pi.',
            },
            {
                name: 'POWER',
            ...
            },
            {
                ...
                description: 'Returns the integer part of a division.',
            },
            {
                name: 'RADIANS',
            ...
            {
                name: 'RANDBETWEEN',
                syntax: 'RANDBETWEEN(LowerBound, UpperBound)',
                description: 'Returns a random integer between two numbers (inclusive).',
            },
            {
                name: 'ROMAN',
            ...
            },
            {
                ...
                description: 'Rounds a number down, toward zero, to a given precision.',
            },
            {
                name: 'ROUNDUP',
                syntax: 'ROUNDUP(Number, Count)',
                description: 'Rounds a number up, away from zero, to a given precision.',
            },
            {
                name: 'SEC',
                syntax: 'SEC(Number)',
            ...
            },
            {
                ...
                description: 'Evaluates a power series at a point.',
            },
            {
                name: 'SIN',
                syntax: 'SIN(Number)',
            ...
            },
            {
                ...
                description: 'Computes an aggregation using the function specified by the number.',
            },
            {
                name: 'SUM',
            ...
            },
            {
                ...
                description: 'Sums cells that meet a specified condition within a range.',
            },
            {
                name: 'SUMIFS',
                syntax: 'SUMIFS(SumRange, CriterionRange1, Criterion1 [, ...])',
                description: 'Sums cells meeting multiple condition sets within ranges.',
            },
            {
                name: 'SUMPRODUCT',
            ...
            },
            {
                ...
                description: 'Returns the sum of the differences of squares of paired values.',
            },
            {
                name: 'SUMX2PY2',
                syntax: 'SUMX2PY2(Range1, Range2)',
                description: 'Returns the sum of the sums of squares of paired values.',
            },
            {
                name: 'SUMXMY2',
                syntax: 'SUMXMY2(Range1, Range2)',
                description: 'Returns the sum of the squares of differences between paired values.',
            },
            {
                name: 'TAN',
                syntax: 'TAN(Number)',
    ...
    },
    {
        ...
        entries: [
            {
                name: 'AND',
                syntax: 'AND(LogicalValue1, LogicalValue2, ...LogicalValueN)',
            ...
            { name: 'FALSE', syntax: 'FALSE()', description: 'Returns the logical value FALSE.' },
            {
                ...
                description: 'Returns one value if a test is TRUE, another if it is FALSE.',
            },
            {
                name: 'IFS',
                syntax: 'IFS(Condition1, Value1 [, Condition2, Value2 [, ...]])',
                description:
                    'Evaluates multiple logical tests and returns the value for the first TRUE condition.',
            },
            {
                name: 'IFNA',
                syntax: 'IFNA(Value, AlternateValue)',
                description:
                    'Returns Value unless it is the #N/A error, in which case returns AlternateValue.',
            },
            {
                name: 'IFERROR',
                syntax: 'IFERROR(Value, AlternateValue)',
                description:
                    'Returns Value unless it is an error, in which case returns AlternateValue.',
            },
            { name: 'NOT', syntax: 'NOT(LogicalValue)', description: 'Inverts a logical value.' },
            {
                name: 'OR',
                syntax: 'OR(LogicalValue1, LogicalValue2, ...LogicalValueN)',
            ...
            },
            {
                ...
                description: 'Returns the result corresponding to the first matching value.',
            },
            { name: 'TRUE', syntax: 'TRUE()', description: 'Returns the logical value TRUE.' },
            {
                name: 'XOR',
                syntax: 'XOR(LogicalValue1, LogicalValue2, ...LogicalValueN)',
        ...
        entries: [
            {
                name: 'CHAR',
                syntax: 'CHAR(Number)',
                description: 'Converts a number into a character according to the code table.',
            },
            {
                name: 'CLEAN',
                syntax: 'CLEAN("Text")',
                description: 'Returns text cleaned of line breaks and non-printable characters.',
            },
            {
                name: 'CODE',
                syntax: 'CODE("Text")',
                description: 'Returns a numeric code for the first character in a string.',
            },
            {
                name: 'CONCATENATE',
            ...
            {
                name: 'FIND',
                syntax: 'FIND("FindText", "WithinText"[, StartNumber])',
                description:
                    'Returns the location of one text string inside another (case-sensitive).',
            },
            {
                name: 'LEFT',
            ...
            },
            {
                name: 'LEN',
                syntax: 'LEN("Text")',
                description: 'Returns the length of a given text.',
            },
            {
                name: 'LOWER',
                syntax: 'LOWER(Text)',
            ...
            },
            {
                ...
                description: 'Returns a substring of a given length from a start position.',
            },
            ...
            {
                name: 'REPLACE',
                syntax: 'REPLACE(Text, StartPosition, Length, NewText)',
                description: 'Replaces a substring of a given length starting at a position.',
            },
            {
                name: 'REPT',
            ...
            {
                name: 'SEARCH',
                syntax: 'SEARCH(SearchString, Text[, StartPosition])',
                description:
                    'Returns the location of a search string inside text (case-insensitive).',
            },
            {
                name: 'SPLIT',
                syntax: 'SPLIT(Text, Index)',
                description:
                    'Divides text using a space as the separator and returns the substring at an index.',
            },
            {
                name: 'SUBSTITUTE',
                syntax: 'SUBSTITUTE(Text, OldText, NewText, [Occurrence])',
                description: 'Returns text where old text has been replaced by new text.',
            },
            {
                name: 'T',
                syntax: 'T(Value)',
            ...
            { name: 'TRIM', syntax: 'TRIM("Text")', description: 'Strips extra spaces from text.' },
            {
                ...
                description: 'Returns the character created from a given code point.',
            },
            {
                name: 'UNICODE',
                syntax: 'UNICODE(Text)',
                description: 'Returns the Unicode code point of the first character of a string.',
            },
            {
                name: 'UPPER',
                syntax: 'UPPER(Text)',
            ...
            },
            {
                name: 'VALUE',
                syntax: 'VALUE(Text)',
                description: 'Parses a number, date, time, or currency from a text string.',
            },
        ],
    },
    {
        ...
        entries: [
            {
                ...
                description:
                    'Returns the specified date as a serial number (days since the null date).',
            },
            {
                name: 'DATEDIF',
                syntax: 'DATEDIF(Date1, Date2, Unit)',
                description: 'Calculates the distance between two dates in a given unit.',
            },
            {
                name: 'DATEVALUE',
                syntax: 'DATEVALUE(DateString)',
                description: 'Parses a date string and returns days since the null date.',
            },
            {
                name: 'DAY',
                syntax: 'DAY(Number)',
            ...
            },
            {
                ...
                description: 'Calculates the difference between two date values, in days.',
            },
            {
                name: 'DAYS360',
                syntax: 'DAYS360(Date2, Date1[, Format])',
                description: 'Calculates the difference between dates using a 360-day year.',
            },
            {
                name: 'EDATE',
                syntax: 'EDATE(StartDate, Months)',
                description:
                    'Shifts a start date by a number of months and returns the serial date.',
            },
            {
                name: 'EOMONTH',
                syntax: 'EOMONTH(StartDate, Months)',
                description:
                    'Returns the last day of the month a given number of months from the start date.',
            },
            {
                name: 'HOUR',
                syntax: 'HOUR(Time)',
                description: 'Returns the hour component of a given time.',
            },
            {
                name: 'INTERVAL',
                syntax: 'INTERVAL(Seconds)',
                description: 'Returns an ISO 8601 interval string from a number of seconds.',
            },
            {
                name: 'ISOWEEKNUM',
            ...
            },
            {
                name: 'MINUTE',
                syntax: 'MINUTE(Time)',
                description: 'Returns the minute component of a given time.',
            },
            {
                name: 'MONTH',
                syntax: 'MONTH(Number)',
            ...
            },
            {
                ...
                description:
                    'Returns the number of working days between two dates with a custom weekend.',
            },
            {
                name: 'NOW',
                syntax: 'NOW()',
            ...
            },
            {
                name: 'SECOND',
                syntax: 'SECOND(Time)',
                description: 'Returns the second component of a given time.',
            },
            {
                name: 'TIME',
                syntax: 'TIME(Hour, Minute, Second)',
                description: 'Returns a number representing the given time as a fraction of a day.',
            },
            {
                name: 'TIMEVALUE',
                syntax: 'TIMEVALUE(TimeString)',
                description: 'Parses a time string and returns a number as a fraction of a day.',
            },
            {
                name: 'TODAY',
                syntax: 'TODAY()',
                description: 'Returns the integer representing the current date.',
            },
            {
                name: 'WEEKDAY',
                syntax: 'WEEKDAY(Date, Type)',
                description: 'Returns a number between 1 and 7 representing the day of the week.',
            },
            {
                name: 'WEEKNUM',
            ...
            },
            {
                ...
                description: 'Returns the working day a given number of days from a start date.',
            },
            {
                name: 'WORKDAY.INTL',
                syntax: 'WORKDAY.INTL(Date, Shift[, Mode[, Holidays]])',
                description:
                    'Returns the working day a given number of days from a start date with a custom weekend.',
            },
            {
                name: 'YEAR',
                syntax: 'YEAR(Number)',
                description: 'Returns the year for the given date value.',
            },
            {
                name: 'YEARFRAC',
                syntax: 'YEARFRAC(Date2, Date1[, Format])',
                description: 'Computes the difference between dates as a fraction of years.',
            },
        ],
    },
    {
        ...
        entries: [
            {
                ...
                description:
                    'Returns the average absolute deviation of the arguments from their mean.',
            },
            {
                name: 'AVERAGE',
            ...
            },
            {
                ...
                description:
                    'Returns the arithmetic mean of the arguments (text and logical values count as 0/1).',
            },
            {
                name: 'AVERAGEIF',
                syntax: 'AVERAGEIF(Range, Criterion [, AverageRange])',
                description: 'Returns the arithmetic mean of cells satisfying a condition.',
            },
            {
                name: 'BESSELI',
                syntax: 'BESSELI(X, N)',
                description: 'Returns the value of the modified Bessel function In(x).',
            },
            {
                name: 'BESSELJ',
                syntax: 'BESSELJ(X, N)',
                description: 'Returns the value of the Bessel function Jn(x).',
            },
            {
                name: 'BESSELK',
                syntax: 'BESSELK(X, N)',
                description: 'Returns the value of the modified Bessel function Kn(x).',
            },
            {
                name: 'BESSELY',
                syntax: 'BESSELY(X, N)',
                description: 'Returns the value of the Bessel function Yn(x).',
            },
            {
                name: 'BETA.DIST',
                syntax: 'BETA.DIST(X, Alpha, Beta, Cumulative[, A[, B]])',
                description: 'Returns the value of the beta distribution density.',
            },
            {
                name: 'BETADIST',
                syntax: 'BETADIST(X, Alpha, Beta, Cumulative[, A[, B]])',
                description: 'Returns the value of the beta distribution density.',
            },
            {
                name: 'BETA.INV',
            ...
            {
                name: 'BINOM.DIST',
                syntax: 'BINOM.DIST(Number, Trials, Probability, Cumulative)',
                description: 'Returns the binomial distribution density.',
            },
            {
                name: 'BINOMDIST',
                syntax: 'BINOMDIST(Number, Trials, Probability, Cumulative)',
                description: 'Returns the binomial distribution density.',
            },
            {
                name: 'BINOM.INV',
                syntax: 'BINOM.INV(Trials, Probability, Alpha)',
                description:
            ...
            {
                name: 'CHIINV',
                syntax: 'CHIINV(Probability, Degrees)',
                description: 'Returns the inverse of the right-tailed chi-squared distribution.',
            },
            {
                name: 'CHIINVRT',
                syntax: 'CHIINVRT(Probability, Degrees)',
                description: 'Returns the inverse of the right-tailed chi-squared distribution.',
            },
            {
                name: 'CHISQ.DIST',
                syntax: 'CHISQ.DIST(X, Degrees, Cumulative)',
                description: 'Returns the chi-squared distribution value.',
            },
            {
                name: 'CHISQ.DIST.RT',
            ...
            {
                name: 'CHISQ.INV',
                syntax: 'CHISQ.INV(Probability, Degrees)',
                description: 'Returns the inverse of the left-tailed chi-squared distribution.',
            },
            {
                name: 'CHISQ.INV.RT',
                syntax: 'CHISQ.INV.RT(Probability, Degrees)',
                description: 'Returns the inverse of the right-tailed chi-squared distribution.',
            },
            {
                name: 'CHISQ.TEST',
                syntax: 'CHISQ.TEST(Array1, Array2)',
                description: 'Returns the chi-squared test value for a dataset.',
            },
            {
                name: 'CHITEST',
            ...
            },
            {
                ...
                description: 'Returns the upper confidence bound for the normal distribution.',
            },
            {
            ...
            },
            {
                ...
                description: 'Returns the upper confidence bound for the Student-t distribution.',
            },
            {
                name: 'CORREL',
            ...
            },
            {
                ...
                description: 'Counts how many values (non-empty) are in the list of arguments.',
            },
            {
                name: 'COUNTBLANK',
                syntax: 'COUNTBLANK(Range)',
                description: 'Returns the number of empty cells in a range.',
            },
            {
                name: 'COUNTIF',
                syntax: 'COUNTIF(Range, Criteria)',
                description: 'Returns the count of cells in a range meeting a criterion.',
            },
            {
                name: 'COUNTIFS',
                syntax: 'COUNTIFS(Range1, Criterion1 [, Range2, Criterion2 [, ...]])',
                description: 'Returns the count of cells meeting multiple criteria.',
            },
            {
                name: 'COVAR',
                syntax: 'COVAR(Data1, Data2)',
                description: 'Returns the covariance between datasets (population-normalized).',
            },
            {
                name: 'COVARIANCE.P',
            ...
            },
            {
                ...
                description: 'Returns the covariance between datasets (sample-normalized).',
            },
            {
                name: 'COVARIANCES',
            ...
            },
            {
                ...
                description: 'Returns the inverse binomial distribution value.',
            },
            {
                name: 'DEVSQ',
            ...
            },
            {
                ...
                description: 'Returns the density of the exponential distribution.',
            },
            {
                name: 'EXPONDIST',
            ...
            {
                name: 'FINV',
                syntax: 'FINV(Probability, Degree1, Degree2)',
                description: 'Returns the inverse of the right-tailed F distribution.',
            },
            {
                name: 'F.DIST',
                syntax: 'F.DIST(X, Degree1, Degree2, Cumulative)',
                description: 'Returns the F distribution density.',
            },
            {
                name: 'F.DIST.RT',
            ...
            {
                name: 'F.INV',
                syntax: 'F.INV(Probability, Degree1, Degree2)',
                description: 'Returns the inverse of the left-tailed F distribution.',
            },
            {
                name: 'F.INV.RT',
                syntax: 'F.INV.RT(Probability, Degree1, Degree2)',
                description: 'Returns the inverse of the right-tailed F distribution.',
            },
            {
                name: 'FINVRT',
                syntax: 'FINVRT(Probability, Degree1, Degree2)',
                description: 'Returns the inverse of the right-tailed F distribution.',
            },
            {
                name: 'FISHER',
                syntax: 'FISHER(Number)',
                description: 'Returns the Fisher transformation value.',
            },
            {
                name: 'FISHERINV',
            ...
            },
            {
                ...
                description: 'Returns the F-test value for a dataset.',
            },
            {
                name: 'FTEST',
            ...
            },
            {
                ...
                description: 'Returns the gamma distribution density.',
            },
            {
                name: 'GAMMADIST',
            ...
            },
            {
                ...
                syntax: 'GAUSS(Number)',
                description:
                    'Returns the probability that a Gaussian variable is between the mean and Number standard deviations.',
            },
            {
                name: 'GEOMEAN',
                syntax: 'GEOMEAN(Number1, Number2, ...NumberN)',
                description: 'Returns the geometric mean of the arguments.',
            },
            {
                name: 'HARMEAN',
            ...
            {
                name: 'HYPGEOMDIST',
                syntax: 'HYPGEOMDIST(SampleS, NumberSample, PopulationS, NumberPop, Cumulative)',
                description: 'Returns the hypergeometric distribution density.',
            },
            {
                name: 'HYPGEOM.DIST',
                syntax: 'HYPGEOM.DIST(SampleS, NumberSample, PopulationS, NumberPop, Cumulative)',
                description: 'Returns the hypergeometric distribution density.',
            },
            {
                name: 'LARGE',
            ...
            {
                name: 'LOGNORM.DIST',
                syntax: 'LOGNORM.DIST(X, Mean, Stddev, Cumulative)',
                description: 'Returns the lognormal distribution density.',
            },
            {
                name: 'LOGNORMDIST',
                syntax: 'LOGNORMDIST(X, Mean, Stddev, Cumulative)',
                description: 'Returns the lognormal distribution density.',
            },
            {
                name: 'LOGNORM.INV',
                syntax: 'LOGNORM.INV(Probability, Mean, Stddev)',
                description: 'Returns the inverse of the lognormal distribution.',
            },
            {
                name: 'LOGNORMINV',
                syntax: 'LOGNORMINV(Probability, Mean, Stddev)',
                description: 'Returns the inverse of the lognormal distribution.',
            },
            {
                name: 'LOGINV',
            ...
            },
            {
                ...
                description:
                    'Returns the maximum value in a list of arguments (text and logical values count).',
            },
            {
                name: 'MAXIFS',
                syntax: 'MAXIFS(MaxRange, CriterionRange1, Criterion1 [, ...])',
                description: 'Returns the maximum value of cells meeting multiple criteria.',
            },
            {
                name: 'MEDIAN',
            ...
            },
            {
                ...
                description:
                    'Returns the minimum value in a list of arguments (text and logical values count).',
            },
            {
                name: 'MINIFS',
                syntax: 'MINIFS(MinRange, CriterionRange1, Criterion1 [, ...])',
                description: 'Returns the minimum value of cells meeting multiple criteria.',
            },
            {
                name: 'NEGBINOM.DIST',
                syntax: 'NEGBINOM.DIST(Failures, Successes, Probability, Cumulative)',
                description: 'Returns the negative binomial distribution density.',
            },
            {
                name: 'NEGBINOMDIST',
                syntax: 'NEGBINOMDIST(Failures, Successes, Probability, Cumulative)',
                description: 'Returns the negative binomial distribution density.',
            },
            {
                name: 'NORM.DIST',
                syntax: 'NORM.DIST(X, Mean, Stddev, Cumulative)',
                description: 'Returns the normal distribution density.',
            },
            {
                name: 'NORMDIST',
            ...
            },
            {
                ...
                description: 'Returns the standard normal distribution density.',
            },
            {
                name: 'NORMSDIST',
            ...
            {
                name: 'NORM.INV',
                syntax: 'NORM.INV(Probability, Mean, Stddev)',
            ...
            },
            {
                ...
                description: 'Returns the Pearson correlation coefficient between two datasets.',
            },
            {
                name: 'PHI',
                syntax: 'PHI(X)',
                description: 'Returns the probability density of the standard normal distribution.',
            },
            {
                name: 'POISSON',
                syntax: 'POISSON(X, Mean, Cumulative)',
                description: 'Returns the Poisson distribution density.',
            },
            {
                name: 'POISSON.DIST',
            ...
            },
            {
                ...
                description: 'Returns the squared Pearson correlation coefficient.',
            },
            {
                name: 'SKEW',
                syntax: 'SKEW(Number1, Number2, ...NumberN)',
                description: 'Returns the skewness of a sample.',
            },
            {
                name: 'SKEW.P',
            ...
            },
            {
                ...
                description:
                    'Returns a normalized value with respect to mean and standard deviation.',
            },
            {
                name: 'STDEV',
            ...
            },
            {
                ...
                description:
                    'Returns the standard deviation of a sample (text and logical values count).',
            },
            {
                name: 'STDEVP',
            ...
            },
            {
                ...
                description:
                    'Returns the standard deviation of a population (text and logical values count).',
            },
            {
                name: 'STDEV.S',
            ...
            },
            {
                ...
                description: 'Returns the standard error of the predicted y-value.',
            },
            {
                name: 'TDIST',
                syntax: 'TDIST(X, Degrees, Mode)',
                description: 'Returns the Student-t distribution density.',
            },
            {
                name: 'T.DIST',
                syntax: 'T.DIST(X, Degrees, Cumulative)',
                description: 'Returns the Student-t distribution density.',
            },
            {
                name: 'T.DIST.2T',
                syntax: 'T.DIST.2T(X, Degrees)',
                description: 'Returns the two-tailed Student-t distribution probability.',
            },
            {
                name: 'TDIST2T',
            ...
            },
            {
                ...
                description: 'Returns the right-tailed Student-t distribution probability.',
            },
            {
                name: 'TDISTRT',
            ...
            {
                name: 'TINV',
                syntax: 'TINV(Probability, Degrees)',
            ...
            {
                name: 'TINV2T',
                syntax: 'TINV2T(Probability, Degrees)',
                description: 'Returns the inverse two-tailed Student-t distribution.',
            },
            {
                name: 'TTEST',
                syntax: 'TTEST(Array1, Array2)',
                description: 'Returns the t-test value for a dataset.',
            },
            {
                name: 'T.TEST',
            ...
            },
            {
                ...
                description: 'Returns the variance of a sample (text and logical values count).',
            },
            {
                name: 'VARP',
            ...
            },
            {
                ...
                description:
                    'Returns the variance of a population (text and logical values count).',
            },
            {
                name: 'VAR.S',
            ...
            },
            {
                ...
                description: 'Returns the Weibull distribution density.',
            },
            {
                name: 'WEIBULL.DIST',
            ...
            {
                name: 'WEIBULLDIST',
                syntax: 'WEIBULLDIST(X, Alpha, Beta, Cumulative)',
                description: 'Returns the Weibull distribution density.',
            },
            {
                name: 'Z.TEST',
                syntax: 'Z.TEST(Array, X[, Sigma])',
                description: 'Returns the z-test value for a dataset.',
            },
            {
                name: 'ZTEST',
    ...
    },
    {
        ...
        entries: [
            ...
            },
            {
                ...
                description: 'Returns depreciation using the fixed-declining balance method.',
            },
            {
                name: 'DDB',
            ...
            },
            {
                ...
                description: 'Converts a price in fractional notation to a decimal number.',
            },
            {
                name: 'DOLLARFR',
                syntax: 'DOLLARFR(Price, Fraction)',
                description: 'Converts a decimal price to fractional notation.',
            },
            {
                name: 'EFFECT',
                syntax: 'EFFECT(NominalRate, NPerY)',
                description: 'Calculates the effective annual interest rate from the nominal rate.',
            },
            {
                name: 'FV',
            ...
            },
            {
                ...
                description: 'Returns the interest portion of a loan payment in a given period.',
            },
            {
                name: 'IRR',
            ...
            },
            {
                ...
                description: 'Returns the interest paid for a given period of an investment.',
            },
            {
                name: 'MIRR',
            ...
            {
                name: 'NOMINAL',
                syntax: 'NOMINAL(EffectRate, NPerY)',
            ...
            },
            {
                ...
                description:
                    'Returns the number of periods required for an investment to reach a specific value.',
            },
            {
                name: 'PMT',
            ...
            },
            {
                ...
                description: 'Returns the principal portion of a loan payment.',
            },
            {
                name: 'PV',
            ...
            },
            {
                ...
                description:
                    'Returns the equivalent interest rate for an investment growing from Pv to Fv.',
            },
            {
                name: 'SLN',
                syntax: 'SLN(Cost, Salvage, Life)',
                description: 'Returns the depreciation using the straight-line method.',
            },
            {
                name: 'SYD',
                syntax: 'SYD(Cost, Salvage, Life, Period)',
                description: 'Returns the sum-of-years depreciation for an asset over a period.',
            },
            {
                name: 'TBILLEQ',
            ...
            },
            {
                ...
                description:
                    'Returns the net present value for a schedule of irregular cash flows.',
            },
        ],
    },
    {
        ...
        entries: [
            ...
            },
            {
                ...
                description:
                    'Returns the column number of a given reference or of the formula cell.',
            },
            {
                name: 'COLUMNS',
            ...
            },
            {
                ...
                description: 'Returns the formula in a given cell as a string.',
            },
            {
                name: 'HLOOKUP',
                syntax: 'HLOOKUP(SearchCriterion, Array, Index, SortOrder)',
                description:
                    'Searches the first row of an array for a value and returns a value from the same column.',
            },
            {
                name: 'HYPERLINK',
                syntax: 'HYPERLINK(Url[, LinkLabel])',
                description: "Stores a URL in the cell's metadata.",
            },
            {
                name: 'INDEX',
                syntax: 'INDEX(Range, Row [, Column])',
                description:
                    'Returns the contents of a cell by row and column number within a range.',
            },
            {
                name: 'MATCH',
                syntax: 'MATCH(SearchCriterion, LookupArray [, MatchType])',
                description: 'Returns the relative position of a matching item in an array.',
            },
            {
                name: 'OFFSET',
                syntax: 'OFFSET(Reference, Rows, Columns, Height, Width)',
                description: 'Returns the value of a cell offset by a number of rows and columns.',
            },
            {
                name: 'ROW',
                syntax: 'ROW([Reference])',
                description: 'Returns the row number of a given reference or of the formula cell.',
            },
            {
                name: 'ROWS',
                syntax: 'ROWS(Array)',
            ...
            },
            {
                ...
                description:
                    'Searches the first column of an array for a value and returns a value from the same row.',
            },
            {
                name: 'XLOOKUP',
                syntax: 'XLOOKUP(LookupValue, LookupArray, ReturnArray, [IfNotFound], [MatchMode], [SearchMode])',
                description: 'Searches for a key in a range and returns the closest match.',
            },
        ],
    },
    {
        ...
        entries: [
            {
                ...
                description: 'Returns TRUE if the provided value is a valid binary string.',
            },
            {
                name: 'ISBLANK',
            ...
            },
            {
                name: 'ISERR',
                syntax: 'ISERR(Value)',
                description: 'Returns TRUE if the value is an error other than #N/A.',
            },
            {
                name: 'ISERROR',
            ...
            },
            {
                name: 'ISEVEN',
                syntax: 'ISEVEN(Value)',
                description: 'Returns TRUE if the value is an even integer.',
            },
            {
                name: 'ISFORMULA',
            ...
            },
            {
                ...
                description: 'Returns TRUE for a logical value (TRUE or FALSE).',
            },
            {
                name: 'ISNA',
                syntax: 'ISNA(Value)',
            ...
            },
            {
                name: 'ISODD',
                syntax: 'ISODD(Value)',
                description: 'Returns TRUE if the value is an odd integer.',
            },
            {
                name: 'ISREF',
                syntax: 'ISREF(Value)',
                description: 'Returns TRUE if the value is the #REF! error.',
            },
            {
                name: 'ISTEXT',
                syntax: 'ISTEXT(Value)',
                description: 'Returns TRUE if the cell contents are text.',
            },
            {
                name: 'SHEET',
                syntax: 'SHEET([Value])',
                description: "Returns the sheet number of a given value or of the formula's sheet.",
            },
            {
                name: 'SHEETS',
                syntax: 'SHEETS([Value])',
                description: 'Returns the number of sheets in a reference or in the workbook.',
            },
            { name: 'NA', syntax: 'NA()', description: 'Returns the #N/A error value.' },
            {
                name: 'VERSION',
                syntax: 'VERSION()',
                description: 'Returns the HyperFormula version string powering the formula engine.',
            },
        ],
    },
    {
        ...
        entries: [
            ...
            },
            {
                ...
                description: 'Returns a bitwise logical AND of two numbers.',
            },
            {
                name: 'BITLSHIFT',
            ...
            },
            {
                ...
                description: 'Returns a bitwise logical OR of two numbers.',
            },
            {
                name: 'BITRSHIFT',
            ...
            },
            {
                ...
                description: 'Returns a complex number from real and imaginary parts.',
            },
            {
                name: 'DEC2BIN',
            ...
            },
            {
                ...
                description: 'Returns the value of the Gauss error integral.',
            },
            {
                name: 'ERFC',
                syntax: 'ERFC(LowerLimit)',
                description: 'Returns the complementary Gauss error integral.',
            },
            {
                name: 'HEX2BIN',
            ...
            },
            {
                ...
                description: 'Returns the argument θ of a complex number.',
            },
            {
                name: 'IMCONJUGATE',
            ...
            },
            {
                ...
                description: 'Returns the exponent of a complex number.',
            },
            {
                name: 'IMLN',
                syntax: 'IMLN(Complex)',
        ...
        entries: [
            {
                ...
                description: 'Adds two values. Implements the `+` operator.',
            },
            {
                name: 'HF.CONCAT',
                syntax: 'HF.CONCAT(String, String)',
                description: 'Concatenates two strings. Implements the `&` operator.',
            },
            {
                name: 'HF.DIVIDE',
                syntax: 'HF.DIVIDE(Number, Number)',
                description: 'Divides two values. Implements the `/` operator.',
            },
            {
                name: 'HF.EQ',
                syntax: 'HF.EQ(Value, Value)',
                description: 'Tests two values for equality. Implements the `=` operator.',
            },
            {
                name: 'HF.LTE',
                syntax: 'HF.LTE(Value, Value)',
                description:
                    'Tests two values for the less-than-or-equal relation. Implements the `<=` operator.',
            },
            {
                name: 'HF.LT',
                syntax: 'HF.LT(Value, Value)',
                description:
                    'Tests two values for the less-than relation. Implements the `<` operator.',
            },
            {
                name: 'HF.GTE',
                syntax: 'HF.GTE(Value, Value)',
                description:
                    'Tests two values for the greater-than-or-equal relation. Implements the `>=` operator.',
            },
            {
                name: 'HF.GT',
                syntax: 'HF.GT(Value, Value)',
                description:
                    'Tests two values for the greater-than relation. Implements the `>` operator.',
            },
            {
                name: 'HF.MINUS',
                syntax: 'HF.MINUS(Number, Number)',
                description: 'Subtracts two values. Implements the binary `-` operator.',
            },
            {
                name: 'HF.MULTIPLY',
                syntax: 'HF.MULTIPLY(Number, Number)',
                description: 'Multiplies two values. Implements the `*` operator.',
            },
            {
                name: 'HF.NE',
                syntax: 'HF.NE(Value, Value)',
                description: 'Tests two values for inequality. Implements the `<>` operator.',
            },
            {
                name: 'HF.POW',
                syntax: 'HF.POW(Number, Number)',
                description: 'Raises a value to a power. Implements the `^` operator.',
            },
            {
                name: 'HF.UMINUS',
                syntax: 'HF.UMINUS(Number)',
                description: 'Negates a value. Implements the unary `-` operator.',
            },
            {
                name: 'HF.UNARY_PERCENT',
                syntax: 'HF.UNARY_PERCENT(Number)',
                description: 'Applies the percent operator (divides by 100).',
            },
            {
                name: 'HF.UPLUS',
                syntax: 'HF.UPLUS(Number)',
                description: 'Applies the unary `+` operator.',
            },
        ],
    },
    {
        ...
        entries: [
            ...
            {
                name: 'MEDIANPOOL',
                syntax: 'MEDIANPOOL(Range, WindowSize, Stride)',
                description: 'Returns a smaller range that is the median of a sliding window.',
            },
            {
                name: 'MAXPOOL',
                syntax: 'MAXPOOL(Range, WindowSize, Stride)',
                description: 'Returns a smaller range that is the maximum of a sliding window.',
            },
            {
                name: 'TRANSPOSE',
        ...
        entries: [
            {
                ...
                description: 'Enables array-arithmetic mode for a formula.',
            },
            {
                name: 'FILTER',
                syntax: 'FILTER(SourceArray, BoolArray1, BoolArray2, ...BoolArrayN)',
                description: 'Filters an array based on one or more boolean conditions.',
            },
            {
                name: 'ARRAY_CONSTRAIN',
                syntax: 'ARRAY_CONSTRAIN(Array, Height, Width)',
                description: 'Truncates an array to the given dimensions.',
            },
        ],
    },
]

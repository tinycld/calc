...
// to match the existing FunctionListDialog / KeyboardShortcutsDialog
// pattern in calc — both are simple, RN-only modals and we keep the
// surface consistent so the dialog handling stays predictable. The
